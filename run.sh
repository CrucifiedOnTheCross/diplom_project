...
python train.py --name "baseline_ce" --loss ce --batch_size 32
python train.py --name "baseline_ce_aug" --loss ce --augment --batch_size 32

# БЛОК 2: Балансировка на уровне АЛГОРИТМА (Focal Loss)
echo "-> [2/4] Запуск алгоритмической балансировки (Focal Loss + Dynamic Alpha)..."
python train.py --name "focal_g0.5_aug" --loss focal --gamma 0.5 --augment --batch_size 32
python train.py --name "focal_g1.0_aug" --loss focal --gamma 1.0 --augment --batch_size 32
python train.py --name "focal_g2.0_aug" --loss focal --gamma 2.0 --augment --batch_size 32
...
python train.py --name "ce_sampler" --loss ce --sampler --batch_size 32
# Сравниваем сэмплер + аугментацию с Focal Loss
python train.py --name "ce_sampler_aug" --loss ce --augment --sampler --batch_size 32
...
python train.py --name "double_focal_g0.5_aug" --loss focal --gamma 0.5 --augment --sampler --batch_size 32
python train.py --name "double_focal_g1.0_aug" --loss focal --gamma 1.0 --augment --sampler --batch_size 32
python train.py --name "double_focal_g2.0_aug" --loss focal --gamma 2.0 --augment --sampler --batch_size 32
